...
> Menu-App-React is a small project created with React.js and styled with TailwindCSS. It features a menu that you can filter by category as desired. For a better understanding, download the project or check out the live demo.
